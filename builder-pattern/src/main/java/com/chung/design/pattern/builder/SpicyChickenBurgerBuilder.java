...
/**
 * Created by Chung.
 * Usage: 辣鸡腿汉堡的制作子流程及实现细节
 * Description:
 * Create dateTime: 18/10/17
 */
public class SpicyChickenBurgerBuilder implements BurgerBuilder {

	private Burger burger = new Burger();

	@Override
	public void buildBread() {
		String bread = "Bread[Regular bun] * 2";
