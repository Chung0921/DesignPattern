 ...
 */
public class AirPlane747Colleague extends Colleague {
	 ...
	 */
	protected AirPlane747Colleague( Mediator mediator ) {
		super( mediator );
	}

	@Override
	public void dealMsg( String msg ) {
		System.out.println( "AirPlane747Colleague received msg is:" + msg );
	}
}
